...
export const metadata: Metadata = {
  title:       { default: 'Memoriza', template: '%s — Memoriza' },
  description: 'Never forget what matters most. Smart date reminders and beautiful countdown pages.',
  metadataBase: new URL(process.env.NEXT_PUBLIC_BASE_URL ?? 'https://memoriza.app'),
  openGraph: { siteName: 'Memoriza', type: 'website' },
}
